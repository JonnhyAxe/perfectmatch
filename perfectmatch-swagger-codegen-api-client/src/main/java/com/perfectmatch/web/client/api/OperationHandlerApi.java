...
@Component("com.perfectmatch.web.client.api.OperationHandlerApi")
public class OperationHandlerApi {
    ...
    public Object handleUsingGET(Object body) throws RestClientException {
        ...
        String path = UriComponentsBuilder.fromPath("/actuator/health/{component}/{instance}").build().toUriString();
    ...
    public Object handleUsingGET1(Object body) throws RestClientException {
        ...
        String path = UriComponentsBuilder.fromPath("/actuator/health/{component}").build().toUriString();
    ...
    public Object handleUsingGET2(Object body) throws RestClientException {
        ...
        String path = UriComponentsBuilder.fromPath("/actuator/health").build().toUriString();
     ...
     * @throws RestClientException if an error occurs while attempting to invoke the API
     */
    public Object handleUsingGET3(Object body) throws RestClientException {
        Object postBody = body;
        
        String path = UriComponentsBuilder.fromPath("/actuator/info").build().toUriString();

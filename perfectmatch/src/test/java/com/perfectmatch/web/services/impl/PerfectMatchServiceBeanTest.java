...
public class PerfectMatchServiceBeanTest {
  ...
  @Mock PerfectMatchRepository dao;
  
  @InjectMocks PerfectMatchServiceBean perfectMatchService;
  ...
  public void findPerfectMatchByName() {
	  ...
	  Mockito.when(this.dao.findByName(perfectMatchName)).thenReturn(expectedPerfectMatch);
	  
	  //When 
	  PerfectMatch actualPerfectMatch = perfectMatchService.findPerfectMatchByName(perfectMatchName);
  ...
  public void savePerfectMatch() {
	  ...
	  Mockito.when(this.dao.save(expectedPerfectMatch)).thenReturn(expectedPerfectMatch);
	  
	  //When 
	  PerfectMatch actualPerfectMatch = perfectMatchService.save(expectedPerfectMatch);

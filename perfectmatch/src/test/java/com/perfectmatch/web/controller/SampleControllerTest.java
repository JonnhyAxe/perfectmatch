...
public class SampleControllerTest {
  ...
  private static final String CHECK_THAT_SAMPLE_NAME_AND_ID_IS_FILLED_IN =
      "Check that sample fileds are filled in";
  ...
  private JacksonTester<Flux<Sample>> jsonSamples;
  ...
  public void setup() {
    ...
    mvc = MockMvcBuilders.standaloneSetup(sampleController).setControllerAdvice(
        new RestResponseEntityExceptionHandler(), new SampleControllerExceptionHandler()).build();
  }

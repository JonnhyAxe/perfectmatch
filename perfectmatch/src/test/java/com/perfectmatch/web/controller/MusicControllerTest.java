...
public class MusicControllerTest {
  ...
  private static final String CHECK_THAT_MUSIC_NAME_AND_ID_IS_FILLED_IN =
      "Check that music name and id is filled in";
  ...
  private JacksonTester<Flux<Music>> jsonMusics;
  ...
  public void setup() {
    ...
    mvc = MockMvcBuilders.standaloneSetup(musicController).setControllerAdvice(
        new RestResponseEntityExceptionHandler(), new MusicControllerExceptionHandler()).build();
  }
  ...
  public void saveArtist() throws Exception {
    ...
    Music expectedArtist = new Music(); // TODO: use builder pattern

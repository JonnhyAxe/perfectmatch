...
public class MemoryMessageStorage implements MessageStorage {
  ...
  public Message findMessage(long id) {
    ...
    if (storageDelegate != null) storageDelegate.findMessage(id);
  ...
  public Collection<Message> findAllMessages() {
    ...
    if (storageDelegate != null) storageDelegate.findAllMessages();
  ...
  public void addMessage(Message message) {
    ...
    if (storageDelegate != null) storageDelegate.addMessage(message);
  }
}

...
const PROFICIENCY_ABOVE40 = 'above4';
const PROFICIENCY_ABOVE60 = 'above6';
const PROFICIENCY_ABOVE80 = 'above8';

const PROFICIENCY_NAMES = ['No Filter', 'Above 4%', 'Above 6%', 'Above 8%'];
